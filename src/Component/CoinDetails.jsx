import { Container, HStack, Radio, RadioGroup, VStack, Text, Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Badge, Progress, Box, Button, Stack } from '@chakra-ui/react'
        ...
        <Container maxW={'container.xl'}>
            {
                loading ? <Loader /> : (
                    <>
                        ...
                        <Stack spacing={'4'} p={'16'} alignItems={'flex-start'}>
